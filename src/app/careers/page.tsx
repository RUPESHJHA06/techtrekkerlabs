...
const perks = [
  ...
  { emoji: '📚', title: 'Learning Budget', body: '$500/year for courses, certifications, and conferences.' },
    ...
    <main>
      ...
      <section className="relative bg-slate-950 border-b border-slate-800/60 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-20">
          <div className="max-w-2xl">
            <h1 className="text-4xl font-bold text-slate-50 mb-3">Join Our Team</h1>
            <p className="text-slate-400 text-base leading-relaxed">
              We are always looking for talented developers and cybersecurity professionals who love building things that matter.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-14 bg-slate-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-xl font-bold text-slate-100 mb-7">Why Work at TechTrekker Labs</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {perks.map((perk) => (
              <div key={perk.title} className="flex gap-4 bg-slate-800/40 border border-slate-700/50 rounded-xl p-5 hover:border-blue-500/30 transition-colors duration-300">
                <span className="text-2xl leading-none">{perk.emoji}</span>
                <div>
                  <h3 className="font-semibold text-slate-200 mb-1 text-sm">{perk.title}</h3>
                  <p className="text-slate-500 text-sm leading-relaxed">{perk.body}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="py-14 bg-slate-950">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-xl font-bold text-slate-100 mb-7">Open Positions</h2>
          <div className="bg-slate-800/30 border border-slate-700/50 border-dashed rounded-2xl py-16 px-8 text-center">
            <div className="w-14 h-14 bg-slate-700/50 border border-slate-600/50 rounded-xl flex items-center justify-center mx-auto mb-4">
            ...
            <h3 className="text-slate-200 font-semibold text-lg mb-2">No Open Positions Right Now</h3>
      ...
      <section className="py-12 bg-slate-900 border-t border-slate-800/60">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="relative overflow-hidden bg-gradient-to-br from-blue-900/40 via-indigo-900/20 to-slate-900/60 border border-blue-500/20 rounded-2xl p-8 text-center">
            ...
            <h2 className="text-xl font-bold text-slate-100 mb-2">Interested in Working With Us?</h2>
