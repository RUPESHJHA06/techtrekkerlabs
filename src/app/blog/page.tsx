  ...
  return (
    <main>
      ...
      <section className="relative bg-slate-950 border-b border-slate-800/60 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-20">
          <div className="max-w-2xl">
            <h1 className="text-4xl font-bold text-slate-50 mb-3">Blog</h1>
            <p className="text-slate-400 text-base leading-relaxed">
              Insights, guides, and updates from our engineering and cybersecurity team.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 md:py-16 bg-slate-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-base font-bold text-slate-300 mb-5 uppercase tracking-widest text-xs">
            All Articles
          </h2>
          ...
          <div className="relative overflow-hidden bg-gradient-to-br from-blue-900/40 via-indigo-900/20 to-slate-900/60 border border-blue-500/20 rounded-2xl p-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-2 justify-center max-w-sm mx-auto">
              <input
                ...
                className="flex-1 px-4 py-2.5 bg-slate-800/60 border border-slate-700 rounded-lg text-sm text-slate-100 placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-blue-500/40 focus:border-blue-500/50 transition-all"
              />
