...
const contactInfo = [
  { Icon: MailIcon, label: 'Email', value: 'hello@techtrekkerlabs.com', href: 'mailto:hello@techtrekkerlabs.com' },
  { Icon: PhoneIcon, label: 'Phone', value: '+1 (555) 123-4567', href: 'tel:+15551234567' },
  { Icon: MapPinIcon, label: 'Location', value: 'Remote · Worldwide', href: null },
];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
            ...
            <div className="lg:col-span-1 space-y-6">
              ...
              <div className="bg-blue-500/10 border border-blue-500/20 rounded-xl p-5">
                <h3 className="font-semibold text-slate-100 text-sm mb-1.5">Free Discovery Call</h3>
                <p className="text-slate-400 text-xs leading-relaxed">
                  Not sure where to start? Book a free 30-minute call to discuss your project.
                </p>
              </div>
            </div>
