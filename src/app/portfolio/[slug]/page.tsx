...
export default async function CaseStudyPage({
  ...
  return (
    <main>
      ...
      {/* Metrics bar */}
      <section className="bg-slate-900 border-b border-slate-800/60">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="space-y-10">
            ...
            <div>
              <div className="flex items-center gap-3 mb-3">
                ...
                <h2 className="text-base font-bold text-slate-100 uppercase tracking-widest text-xs">The Problem</h2>
              </div>
              <div className="pl-10">
            ...
            <div>
              <div className="flex items-center gap-3 mb-3">
                ...
                <h2 className="text-base font-bold text-slate-100 uppercase tracking-widest text-xs">Our Solution</h2>
              </div>
              <div className="pl-10">
            ...
            <div>
              <div className="flex items-center gap-3 mb-3">
                ...
                <h2 className="text-base font-bold text-slate-100 uppercase tracking-widest text-xs">The Result</h2>
              </div>
              <div className="pl-10">
          ...
          <div className="mt-10 pt-8 border-t border-slate-800">
            ...
            <div className="flex flex-wrap gap-2">
              {project.tech.map((t) => (
                <span key={t} className="px-3 py-1 bg-slate-800/60 border border-slate-700/50 text-slate-300 text-xs rounded-md font-medium">
                  {t}
                </span>
              ))}
            </div>
      ...
      <section className="py-12 bg-slate-950 border-t border-slate-800/60">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-lg font-bold text-slate-100 mb-6">More Case Studies</h2>
      ...
      <section className="py-12 bg-slate-900 border-t border-slate-800/60">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="relative overflow-hidden bg-gradient-to-br from-blue-900/40 via-indigo-900/20 to-slate-900/60 border border-blue-500/20 rounded-2xl p-8 text-center">
            ...
            <h2 className="text-xl font-bold text-slate-100 mb-2">Want a result like this?</h2>
